...
//NOVO LAYOUT
Route::get('/novo/index', [App\Http\Controllers\NovoController::class, 'index'])
    ->name('novo-index');
...
Route::middleware('auth')->group(
    function () {
        ...
        Route::get('/anuncio/detalhe/{id}', [App\Http\Controllers\AnuncioController::class, 'detalhe'])
            ->name('anuncio-detalhe');
        Route::get('/anuncio/editar/{id}', [App\Http\Controllers\AnuncioController::class, 'edit'])
            ->name('anuncio-editar');
...
// Route::middleware('auth')->group(function () {
//Template
Route::get('/site', [App\Http\Controllers\TemplateController::class, 'index'])
    ->name('template');
Route::get('/site/detalhe/{id?}', [App\Http\Controllers\TemplateController::class, 'detalhe'])
    ->name('site-detalhe');
...
Route::get('profiletemp', [App\Http\Controllers\TemplateController::class, 'profiletemp'])
    ->name('profiletemp');
Route::get('cotacao', [App\Http\Controllers\TemplateController::class, 'scraping'])
    ->name('cotacao');
// });
