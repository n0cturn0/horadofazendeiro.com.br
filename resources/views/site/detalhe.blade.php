    ...
    <div class="container">
      ...
      <div class="row content-reverse">
        ...
        <div class="col-lg-6">
          ...
          <div class="common-card">
            <div class="ad-details-meta"><a href="{{ route('template') }}"
                 class="view"><i class="fas fa-arrow-left"></i><span>Voltar<strong></strong></span></a>
            </div>
            ...
            <a aria-label="Chat on WhatsApp"
               href="https://wa.me/{{ $anuncio['usuario']['telefone'] }}"><img width="40"
                   height="40"
